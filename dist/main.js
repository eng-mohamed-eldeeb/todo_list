...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ checkboxs)\n/* harmony export */ });\nfunction checkboxs(index) {\r\n    const todoListString = localStorage.getItem('todoList');\r\n    const todoList = JSON.parse(todoListString);\r\n    if (todoList[index].completed) {\r\n        todoList[index].completed = false;\r\n    } else {\r\n        todoList[index].completed = true;\r\n    }\r\n    const newTodoList = JSON.stringify(todoList);\r\n  localStorage.setItem('todoList', newTodoList);\r\n}\n\n//# sourceURL=webpack://webpack-demo/./src/check.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ edit)\n/* harmony export */ });\nfunction edit(y, todo) {\r\n  const todoListString = localStorage.getItem('todoList');\r\n  const todoList = JSON.parse(todoListString);\r\n  todoList[y].description = todo;\r\n  const newTodoList = JSON.stringify(todoList);\r\n  localStorage.setItem('todoList', newTodoList);\r\n  return todoList;\r\n}\r\n\n\n//# sourceURL=webpack://webpack-demo/./src/edite.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _remove_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./remove.js */ \"./src/remove.js\");\n/* harmony import */ var _add_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add.js */ \"./src/add.js\");\n/* harmony import */ var _show_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./show.js */ \"./src/show.js\");\n/* harmony import */ var _viewInput_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./viewInput.js */ \"./src/viewInput.js\");\n/* harmony import */ var _edite_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edite.js */ \"./src/edite.js\");\n/* harmony import */ var _check_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./check.js */ \"./src/check.js\");\n/* harmony import */ var _remove_checked_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./remove_checked.js */ \"./src/remove_checked.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nlet counter = 0;\r\nconst todoUL = document.querySelector(\"#todoUl\");\r\nconst todo = document.querySelector(\".AddToList\");\r\nconst form = document.getElementById(\"todoForm\");\r\n(0,_show_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(todoUL);\r\n\r\n// export default todoList;\r\nform.addEventListener(\"submit\", (e) => {\r\n  e.preventDefault();\r\n  counter = (0,_add_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(counter, todo.value, false);\r\n  (0,_show_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(todoUL);\r\n  todo.value = \"\";\r\n});\r\n\r\ntodoUL.addEventListener(\"click\", (e) => {\r\n  if (e.target.className.includes(\"delete\")) {\r\n    (0,_remove_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(e.target.parentNode.className);\r\n    (0,_show_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(todoUL);\r\n  }\r\n  if (e.target.className.includes(\"edit\")) {\r\n    (0,_viewInput_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(e.target.parentNode, e.target.parentNode.className);\r\n    const antherForm = document.getElementById(\"editForm\");\r\n    antherForm.addEventListener(\"submit\", (e) => {\r\n      e.preventDefault();\r\n      const val = document.querySelector(\".newAddToList\");\r\n      (0,_edite_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(e.target.parentNode.className, val.value);\r\n      (0,_show_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(todoUL);\r\n    });\r\n  }\r\n  const inputs = document.querySelectorAll(\".cont input\");\r\n\r\n  inputs.forEach((input) => {\r\n    input.addEventListener(\"change\", (e) => {\r\n     (0,_check_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(e.target.parentNode.parentNode.className);\r\n     (0,_show_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(todoUL);\r\n    });\r\n});\r\n});\r\n\r\n\r\nconst span = document.querySelector(\".clearSpan\");\r\n\r\nspan.addEventListener(\"click\", () => {\r\n  (0,_remove_checked_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\r\n  (0,_show_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(todoUL);\r\n});\r\n\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
...
/***/ "./src/remove_checked.js":
/*!*******************************!*\
  !*** ./src/remove_checked.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ removeCecked)\n/* harmony export */ });\nfunction removeCecked() {\r\n    const todoListString = localStorage.getItem('todoList');\r\n    const todoList = JSON.parse(todoListString);\r\n    let newtodoList = todoList.filter((todo) => todo.completed == false);\r\n    const newTodoList = JSON.stringify(newtodoList);\r\n  localStorage.setItem('todoList', newTodoList);\r\n}\n\n//# sourceURL=webpack://webpack-demo/./src/remove_checked.js?");
